...
total_flower_cost=(flour_needed * flour_cost)
...
total_cost = total_butter_cost+total_salt_cost+total_yeast_cost+total_water_cost+total_flower_cost

print(f"Total cost to make {recipe_name}: ${total_cost:.2f}")

# End of dinner rolls RIP
##DEF "define". these are placeholder values. 
...
def calculate_total_cost(
    ...
    print(f"Total cost to make {recipe_name}: ${total_cost:.2f}")
    return total_cost
###2f for 2 decinal places

## do no forget commas
Choco_Cookie_cost = calculate_total_cost(
